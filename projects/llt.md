<div class="container my-4">
  ...
  <p>
    Our goal was to build a scalable, automated system capable of reliably matching large cohorts (150–250 participants each cycle)
  ...
  <ul>
    ...
    <li>Planned and managed sprints for a multi-person development team using Trello and Slack</li>
  ...
  <ul>
    ...
    <li><strong>Three Matching Algorithms</strong>:
      <ul>
        ...
        <li>Location and Availability-Based Matching for optimal pairings</li>
      </ul>
    </li>
    <li><strong>Automated Email Workflows</strong> generating <strong>400+ emails</strong> per cohort with dynamic templates</li>
    <li><strong>Match Pool and Status Tracking</strong> for <strong>200+ active participants</strong> per cycle</li>
    ...
    <li><strong>Dashboard Interfaces</strong> providing visibility into match progress, unmatched users, and key metrics</li>
  </ul>
  ...
  <ul>
    ...
    <li>Delivered detailed manuals, configuration guidelines, and recorded walkthroughs</li>
